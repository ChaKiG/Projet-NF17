...
if (isset($_POST['participer'])) {
    ...
    if ($part2 ===$part1){
    	...
    	echo "combat contre soi-meme !";
    	echo "<a href=\"participer.php\">retour page club</a>";
	...
	$resultat =pg_query($idConnecxion,$query) or die("erreur lors de la creation(match deja créé ?)<br><a href=\"participer.php\">reessayer</a>");
	...
	$confrontation=pg_query($idConnecxion,$query2);
		if ($confrontation){
		 	while ($row = pg_fetch_array($confrontation)) {
				echo $row['part1']." vs ".$row['part2'] ."<br>";
				}
...
<br><a href="connect_club.php">retour a l'accueil club</a><br>
