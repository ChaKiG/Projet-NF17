...
?>      
        ...
        echo "<td><input type =\"submit\" name =\"change\" value =\"" . $row['id'] ."\"></td>";
        echo "</tr>";
...
<?php
        ...
        if (isset($_POST['change'])){
            $querystring = "UPDATE karateka set nom = '".$_POST['nom']."', age = '".$_POST['age']."', poids = '".$_POST['poids']."',taille = '".$_POST['taille']."',ceinture = '".$_POST['ceinture']."',dan = '".$_POST['dan']."' WHERE id = " . $_POST['change'];
            $query=pg_query($idConnecxion,$querystring); 

        }
        if(isset($_POST['ajouter'])){
             $querystring = "INSERT INTO karateka (nom,age,poids,taille,ceinture,dan,nomclub,coordonneesdirigeantclub)VALUES('".$_POST['nom']."', '".$_POST['age']."', '".$_POST['poids']."','".$_POST['taille']."','".$_POST['ceinture']."', '".$_POST['dan']."','".$login."','".$dirigeant."')";
             $query=pg_query($idConnecxion,$querystring); 
        }
